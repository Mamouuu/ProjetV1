...
public class NoeudAppuiSimple extends NoeudAppui{
    //Constructeurs
    NoeudAppuiSimple(int identificateur,double px,double py,Vecteur2D force){
    ...
    NoeudAppuiSimple(double px,double py,Vecteur2D force){
    ...
    NoeudAppuiSimple(double px,double py){
        this.identificateur=-1;
        this.px=px;
        this.py=py;
        force.setVx(0);
